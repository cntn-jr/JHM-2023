 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function ApiSuccess($contents = [], $message = '', $statusCode = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::ApiSuccess($contents, $message, $statusCode);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function ApiFailed($contents = [], $message = '', $statusCode = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::ApiFailed($contents, $message, $statusCode);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function ApiError($contents = [], $message = '', $statusCode = 500)
        {
                        return \Illuminate\Routing\ResponseFactory::ApiError($contents, $message, $statusCode);
        }
